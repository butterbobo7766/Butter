...
function lq()
gg.alert("Thank you for Buy VIP!")
function unXXX(str64)
 ...
 lqc=io.open('/storage/emulated/0/.64078436_1','r')
 if lqc == nil then
   lqc=io.open('/storage/emulated/0/Android/.64078436_int','w')
   lqc:write(lqSJ*6-967)
   lqc=io.open('/storage/emulated/0/.64078436_1','w')
   lqc:write(lqSJ*6-967)
   lqd = io.open('/storage/emulated/0/Android/.64078436_int','r')
   lqdm = lqd:read('*a')
   lqd:close()
 else
  abc=io.open('/storage/emulated/0/Android/.64078436_int','w')
  if abc == nil then
   lqdd = io.open('/storage/emulated/0/.64078436_1','r')
   lqdmm = lqdd:read('*a')
   lqdd:close()
   lqd = io.open('/storage/emulated/0/Android/.64078436_int','w')
   lqd:write(lqdmm)
   lqd:close()
   end
   lqd = io.open('/storage/emulated/0/Android/.64078436_int','r')
 ...
 lqdm = (lqdm + 967)/6
 lqs = io.open('/storage/emulated/0/Android/.64078436_1_dll','r')
 if lqs == nil then
   ...
   if lqsa ~= 1 then print('Wrong') os.exit()
     ...
     if lqA == aaa then
     aaaa = 1
     gg.alert(' Day Key ','Yes')
     else
       if lqA == bbb then
       aaaa = 7
       gg.alert(' Week Key ','Yes')
       else
         if lqA == ccc then
         aaaa = 30
         gg.alert(' Month Key ','Yes')
         else
         if lqA == ddd then
         aaaa = 5000
   ...
   Yza = Yz
   Yzb =io.open('/storage/emulated/0/Android/.64078436_1_dll','w')
   Yzb:write(Yza)
   Yzb:close()
   Yzb =io.open('/storage/emulated/0/.64078436_2','w')
   Yzb:write(100000000-(Yza-lqdm))
   Yzb:close()
 else
   Yzb =io.open('/storage/emulated/0/.64078436_2','r')
   if Yzb == nil then
   os.remove("/storage/emulated/0/.64078436_2")    
   os.remove("/storage/emulated/0/Android/.64078436_1_dll")
   os.remove("/storage/emulated/0/.64078436_1")    
   os.remove("/storage/emulated/0/Android/.64078436_int")
   os.exit()
   end
   YZZZ=Yzb:read('*a')
   Yzb:close()
   Yzd=io.open('/storage/emulated/0/Android/.64078436_1_dll','r')
   Yzda=Yzd:read('*a')
   Yzd:close()
   YZYZ=Yzda-lqdm+YZZZ
