...
function Main()
  MOMO = gg.choice({
    " 💫   Bʏᴘᴀss️ Menu   💫 ",
    "🌸 [Lobby Menu] 🌸 [大廳功能] 🌸",
    "❄ ️[InGame Menu] ❄️ [進場功能] ❄️",
    "🐾️ [Exit] 🐾 ️[離開] 🐾️",
  }, nil, os["date"](" ʜᴀᴄᴋ ʙʏ BᴜΙ͠ᴛᴇʀ \n Date : %A,%d-%B-%Y\n Time : %H:%M[%p] \n"))
  if MOMO == nil then
  end
  if MOMO == 1 then bypass()
  end
  if MOMO == 2 then lobby()
  end
  if MOMO == 3 then game()
  end
  if MOMO == 4 then exit()
...
function bypass()
  ...
  if BABY == nil then Main()
   else
    if BABY[1] == true then a1()
    end
    if BABY[2] == true then b1()
    end
    if BABY[3] == true then Main()
    end
  end
  COW = -1
end
