...
password = gg["alert"]("\n🐮 [牛哥] の [Bᴜᴛᴛᴇʀ] 🐮","🌸 [開始_Enter] 🌸","💀 [退出_Exit] 💀", nil)
...
function lobby()
  menu = gg["multiChoice"]({
    ...
    ""..turn25.."[ᴀɢɢʀᴇꜱꜱɪᴠᴇ ᴀɪᴍʙᴏᴛ][瞄準輔助2]", --y
    ""..turn22.."[ᴜᴀᴠ ʀᴀᴅᴀʀ][ 多人雷達長顯 ]", --uav
    "📈  [ TURNING FPS ] 📉", --z
    "   ↩️  Back  ↩️   ",
  }, nil, os["date"](" ʜᴀᴄᴋ ʙʏ 🐮Bᴜᴛᴛᴇʀ \n🟢 = ON+Off  (開+關) \n🟡 = ON Only (只能開) \n🔶 = Every Match (每場內開啟) "))
...
Var #BC25D54C|bc25d54c|4|0|0|0|0|0|r-xp|/data/app/com.garena.game.codm-PAzBb-clspFfkssRTRpag==/lib/arm/libanogs.so|654c
...
Var #BC25D55C|bc25d55c|4|0|0|0|0|0|r-xp|/data/app/com.garena.game.codm-GPAzBb-clspFfkssRTRpag==/lib/arm/libanogs.si(o
...
function y1() --smooth
  if turn25 == OFF then
    HexPatches.MemoryPatch('libil2cpp.so', 0x6AFE750, '320244E3', 16)
    turn25 = ON
    gg.toast("🟢 Aɢɢʀᴇꜱꜱɪᴠᴇ Aɪᴍʙᴏᴛ ᴀᴄᴛɪᴠᴇ✔")
   else
    so = gg.getRangesList('libil2cpp.so')[1].start
    py = 0x6AFE750
    setvalue(so + py, 16, -286131696)
    gg.clearResults()
    turn25 = OFF
    gg.toast("⚫ Aɢɢʀᴇꜱꜱɪᴠᴇ Aɪᴍʙᴏᴛ Oғғ ")
  end
end
...
function RED()
  RL = gg.alert("RED LINE Menu", "BR [生存]", "MP [多人]")
  if RL == 1 then
    gg.clearResults()
    gg.setVisible(false)
    gg.setRanges(gg.REGION_ANONYMOUS)
...
function z1() --fps
  land = gg.prompt({"🔛 Turning FPS [1; 120]","❌ Default FPS"}, {[1] = 60, [2] = false}, {[1] = data, [1] = "number", [2] = "checkbox"})
  if land == nil then else
    if land[1] then
      TSUM('libil2cpp.so', 0x561BD70, "-3.78023548e28", 16)
      TSUM('libil2cpp.so', 0x2706C70, "3C00A0E31EFF2FE1", 32)
      TSUM('libil2cpp.so', 0x2707618, "3C00A0E31EFF2FE1", 32)
      TSUM('libil2cpp.so', 0x2706C70, tostring(land[1]), 1)
      TSUM('libil2cpp.so', 0x2707618, tostring(land[1]), 1)
      gg.alert("FPS "..land[1].." ᴀᴄᴛɪᴠᴇ✔")
    end
    if land[2] then
      TSUM('libil2cpp.so', 0x2706C70, "F04D2DE918B08DE2", 32)
      TSUM('libil2cpp.so', 0x2707618, "F04D2DE918B08DE2", 32)
...
function guns()
  HM = gg["multiChoice"]({
    "DLQ-33 Holiday (effect)",
    "DLQ-33 Zealot (effect)",
    "KRM-262 (effect)",
    "AK-47 Radiance",
    "M-13 Morning Start",
    "Kilo-141 Demonsong",
  ...
  if HM == nil then lobby()
   else
    if HM[1] == true then DLQa()
    end
    if HM[2] == true then DLQb()
    end
    if HM[3] == true then KRM()
    end
    if HM[4] == true then AK47()
    end
    if HM[5] == true then M13()
    end
    if HM[6] == true then KILO()
    end
    if HM[7] == true then ODEN()
    end
    if HM[8] == true then GKS()
    end
    if HM[9] == true then RAZOR()
    end
    if HM[10] == true then LOCUS()
    end
    if HM[11] == true then MK2()
    end
    if HM[12] == true then BOLT()
    end
    if HM[13] == true then SPR()
    end
    if HM[14] == true then Main()
    end
    COW = -1
  end
end
...
function DLQa()
  qmnb = {
    {["memory"] = 32},
    {["name"] = "dlq holiday"},
    {["value"] = 10207002, ["type"] = 4},
    {["lv"] = 81, ["offset"] = 4, ["type"] = 4},
  }
  qmxg = {
    {["value"] = 10207022, ["offset"] = 64, ["type"] = 4},
    {["value"] = 84, ["offset"] = 68, ["type"] = 4},
    {["value"] = 10207022, ["offset"] = 72, ["type"] = 4},
  }
  xqmnb(qmnb)

  qmnb = {
    {["memory"] = 32},
    {["name"] = "dlq holiday hack"},
    {["value"] = 200002225, ["type"] = 4},
    {["lv"] = 10206004, ["offset"] = -12, ["type"] = 4},
  }
  qmxg = {
    {["value"] = 200002339, ["offset"] = -152, ["type"] = 4},
  }
  xqmnb(qmnb)
...
function DLQb()
  ...
  qmxg = {
    {["value"] = 10207068, ["offset"] = 64, ["type"] = 4},
    {["value"] = 10634, ["offset"] = 68, ["type"] = 4},
    {["value"] = 10207068, ["offset"] = 72, ["type"] = 4},
  }
  xqmnb(qmnb)

  qmnb = {
    {["memory"] = 32},
    {["name"] = "dlq zealot hack"},
    {["value"] = 200002225, ["type"] = 4},
    {["lv"] = 10206004, ["offset"] = -12, ["type"] = 4},
  }
  qmxg = {
    {["value"] = 200010129, ["offset"] = -152, ["type"] = 4},
  }
  xqmnb(qmnb)
...
function AK47()
  ...
  gg.getResults(10000)
  gg.editAll("100526;100233;66734;66740;66737", gg.TYPE_DWORD)
  gg.clearResults()
  gg.setRanges(gg.REGION_ANONYMOUS)
  gg.searchNumber("200002161;10107001;1057803469", gg.TYPE_DWORD)
  gg.refineNumber("200002161", gg.TYPE_DWORD)
  gg.getResults(10000)
  gg.editAll("66737", gg.TYPE_DWORD)
  gg.clearResults()
  gg.alert(" AK-47 ʀᴀᴅɪᴀɴᴄᴇ ᴀᴄᴛɪᴠᴇ✔ ")
end

function M13()
  gg.setRanges(gg.REGION_ANONYMOUS)
  gg.searchNumber("2;100012;1393;1347;1338::21", gg.TYPE_DWORD)
  gg.getResults(10000)
  gg.editAll("100472;100004;1159;1168;1175", gg.TYPE_DWORD)
  gg.clearResults()
  gg.setRanges(gg.REGION_ANONYMOUS)
  gg.searchNumber("1338;10122001;1057803469", gg.TYPE_DWORD)
  gg.refineNumber("1338", gg.TYPE_DWORD)
  gg.getResults(10000)
  gg.editAll("1175", gg.TYPE_DWORD)
  gg.clearResults()
  gg.alert(" ᴍ13 ᴍᴏʀɴɪɴɢ sᴛᴀʀ ᴀᴄᴛɪᴠᴇ✔ ")
end

function KILO()
  gg.setRanges(gg.REGION_ANONYMOUS)
  gg.searchNumber("2;100149;9187;9205;9196::21", gg.TYPE_DWORD)
  gg.getResults(10000)
  gg.editAll("100511;100155;9470;9488;9479", gg.TYPE_DWORD)
  gg.clearResults()
  gg.setRanges(gg.REGION_ANONYMOUS)
  gg.searchNumber("9196;10124001;1057803469", gg.TYPE_DWORD)
  gg.refineNumber("9196", gg.TYPE_DWORD)
  gg.getResults(10000)
  gg.editAll("9479", gg.TYPE_DWORD)
  gg.clearResults()
  gg.alert(" ᴋɪʟᴏ141 ᴅᴇᴍᴏɴsᴏɴɢ ᴀᴄᴛɪᴠᴇ✔ ")
end

function ODEN()
  qmnb = {
    {["memory"] = 32},
    {["name"] = "ᴏᴅᴇɴ ᴅɪᴠɪɴᴇ sᴍɪᴛᴇ"},
    {["value"] = 68990, ["type"] = 4},
  ...
  xqmnb(qmnb)
  gg.setRanges(gg.REGION_ANONYMOUS)
  gg.searchNumber("10125001;100289;10125001::9", gg.TYPE_DWORD)
  gg.getResults(10000)
  gg.editAll("10125002;100287;10125002", gg.TYPE_DWORD)
  gg.clearResults()
  gg.alert(" ᴏᴅᴇɴ ᴅɪᴠɪɴᴇ sᴍɪᴛᴇ ᴀᴄᴛɪᴠᴇ✔ ")
end

function GKS()
  gg.setRanges(32)
  gg.searchNumber("10412001;136;40::9", gg.TYPE_DWORD)
  gg.getResults(10000)
  gg.editAll("10412025;10311;10412025", gg.TYPE_DWORD)
  gg.clearResults()
  gg.setRanges(32)
  gg.searchNumber("200002373;10412001;1057803469::31", gg.TYPE_DWORD)
  gg.refineNumber("200002373", gg.TYPE_DWORD)
  gg.getResults(10000)
  gg.editAll("200010269", gg.TYPE_DWORD)
  gg.clearResults()
  gg.setRanges(32)
  gg.searchNumber("10412001;59;1880000001;43;0;0;0;0;0;0;0;0::64", gg.TYPE_DWORD)
  gg.refineNumber("0", gg.TYPE_DWORD)
  gg.getResults(10000)
  gg.editAll("0;0;0;0;0;0;200097;300090", gg.TYPE_DWORD)
  gg.clearResults()
  gg.alert(" GKS ᴀᴄᴛɪᴠᴇ✔ ")
end
...
function RAZOR()
  gg.setRanges(32)
  gg.searchNumber("10406015;119;128::9", gg.TYPE_DWORD)
  gg.getResults(10000)
  gg.editAll("10406097;10571;10406090", gg.TYPE_DWORD)
  gg.clearResults()
  gg.setRanges(32)
  gg.searchNumber("200002286;10406015;1057803469::31", gg.TYPE_DWORD)
  gg.refineNumber("200002286", gg.TYPE_DWORD)
  gg.getResults(10000)
  gg.editAll("200010203", gg.TYPE_DWORD)
  gg.clearResults()
  gg.setRanges(32)
  gg.searchNumber("10406015;57;1880000001;45;0;0;0;0;0;0;0;0::64", gg.TYPE_DWORD)
  gg.refineNumber("0", gg.TYPE_DWORD)
  gg.getResults(10000)
  gg.editAll("0;0;0;0;0;0;200046;300037", gg.TYPE_DWORD)
  gg.clearResults()
  gg.alert(" Razorback ᴀᴄᴛɪᴠᴇ✔ ")
end

function LOCUS()
  gg.setRanges(32)
  gg.searchNumber("10208001;85;25::9", gg.TYPE_DWORD)
  gg.getResults(10000)
  gg.editAll("10208077;100128;10208077", gg.TYPE_DWORD)
  gg.clearResults()
  gg.setRanges(32)
  gg.searchNumber("200002349;10208001;1057803469::31", gg.TYPE_DWORD)
  gg.refineNumber("200002349", gg.TYPE_DWORD)
  gg.getResults(10000)
  gg.editAll("8326", gg.TYPE_DWORD)
  gg.clearResults()
  gg.setRanges(32)
  gg.searchNumber("10208001;34;1880000001;84;0;0;0;0;0;0;0;0::64", gg.TYPE_DWORD)
  gg.refineNumber("0", gg.TYPE_DWORD)
  gg.getResults(10000)
  gg.editAll("0;0;0;0;0;0;200108;300101", gg.TYPE_DWORD)
  gg.clearResults()
  gg.alert(" Locus ᴀᴄᴛɪᴠᴇ✔ ")
end

function MK2()
  gg.setRanges(32)
  gg.searchNumber("11204001;10544;11204001::9", gg.TYPE_DWORD)
  gg.getResults(10000)
  gg.editAll("11204002;10521;11204002", gg.TYPE_DWORD)
  gg.clearResults()
  gg.setRanges(32)
  gg.searchNumber("200010381;11204001;1057803469::31", gg.TYPE_DWORD)
  gg.refineNumber("200010381", gg.TYPE_DWORD)
  gg.getResults(10000)
  gg.editAll("200010358", gg.TYPE_DWORD)
  gg.clearResults()
  gg.setRanges(32)
  gg.searchNumber("11204001;36;1880000001;80;0;0;0;0;0;0;0;0::64", gg.TYPE_DWORD)
  gg.refineNumber("0", gg.TYPE_DWORD)
  gg.getResults(10000)
  gg.editAll("0;0;0;0;0;0;200108;300101", gg.TYPE_DWORD)
  gg.clearResults()
...
function BOLT()
  gg.setRanges(32)
  gg.searchNumber("11201001;10033;132::9", gg.TYPE_DWORD)
  gg.getResults(10000)
  gg.editAll("11201003;10640;11201003", gg.TYPE_DWORD)
  gg.clearResults()
  gg.setRanges(32)
  gg.searchNumber("200010085;11201001;1057803469::31", gg.TYPE_DWORD)
  gg.refineNumber("200010085", gg.TYPE_DWORD)
  gg.getResults(10000)
  gg.editAll("200010134", gg.TYPE_DWORD)
  gg.clearResults()
  gg.setRanges(32)
  gg.searchNumber("11201001;34;1880000001;81;0;0;0;0;0;0;0;0::64", gg.TYPE_DWORD)
  gg.refineNumber("0", gg.TYPE_DWORD)
  gg.getResults(10000)
  gg.editAll("0;0;0;0;0;0;200028;300020", gg.TYPE_DWORD)
  gg.clearResults()
  gg.alert(" Kilo Bolt ᴀᴄᴛɪᴠᴇ✔ ")
end

function SPR()
  gg.setRanges(32)
  gg.searchNumber("11203001;10310;11203001::9", gg.TYPE_DWORD)
  gg.getResults(10000)
  gg.editAll("10406109;10233;10406109", gg.TYPE_DWORD)
  gg.clearResults()
  gg.setRanges(32)
  gg.searchNumber("200010268;11203001;1057803469::31", gg.TYPE_DWORD)
  gg.refineNumber("200010268", gg.TYPE_DWORD)
  gg.getResults(10000)
  gg.editAll("200010235", gg.TYPE_DWORD)
  gg.clearResults()
  gg.setRanges(32)
  gg.searchNumber("11203001;34;1880000001;77;0;0;0;0;0;0;0;0::64", gg.TYPE_DWORD)
  gg.refineNumber("0", gg.TYPE_DWORD)
  gg.getResults(10000)
  gg.editAll("0;0;0;0;0;0;200152;300145", gg.TYPE_DWORD)
  gg.clearResults()
  gg.alert(" SP-R 208 ᴀᴄᴛɪᴠᴇ✔ ")
end
